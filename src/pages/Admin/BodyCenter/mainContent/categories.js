...
const Categories =()=>{
    ...
    const postError=category.postError
    const getError=category.loadError
    console.log("===================perr",postError)
            ...
            <div className="row">
                <div className="col-md-6">
                    <div className="main-card mb-3 card">
                        {postError&& <li className="list-group-item-danger list-group-item">There is some Error <br/> Please try again</li>}
                        <div className="card-body"><h5 className="card-title">Create a Category</h5>
                            <form  onSubmit={upload}>
                                <div className="position-relative form-group">
                                    <label htmlFor="exampleEmail" className="">Category Name</label>
                                    <input
                ...
                <div className="col-md-6">
                    <div className="main-card mb-3 card">
                        {getError&& <li className="list-group-item-danger list-group-item">There is some Error <br/> Please try again</li>}
